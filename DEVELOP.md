...
- Use ChatStyle's shared Click tree option on the top-level CLI: `--tree` includes parameter signatures, while `--tree-brief` keeps command nodes and descriptions without signatures.
